...
namespace clarion.housing.console.migration.Models.Cases
{
    public class AdviceSupport
    {
        ...
        [ExcelHeader("Customer Ref")] public string? CustomerRef { get; set; }
        [ExcelHeader("A&S")] public string? AdviceAndSupport { get; set; }
        [ExcelHeader("A&S - SO")] public string? AdviceAndSupportSO { get; set; }
        [ExcelHeader("A&S - WBA")] public string? AdviceAndSupportWBA { get; set; }
        [ExcelHeader("Current Status/ Recent support provided")] public string? CurrentStatus { get; set; }
        [ExcelHeader("Ongoing support required? ")] public string? SupportRequired { get; set; }
        [ExcelHeader("next steps required")] public string? NextSteps { get; set; }
    }
}
